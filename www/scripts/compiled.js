...
require.define("/www/scripts/services/identity.coffee",function(require,module,exports,__dirname,__filename,process,global){(function() {
  var entities, global, identity, _, _base, _ref, _ref1, _ref2;

  _ref = [require('../global'), require('../../../server/entities'), require('underscore')], global = _ref[0], entities = _ref[1], _ = _ref[2];

  if ((_ref1 = global.state) == null) {
    global.state = {};
  }

  identity = (_ref2 = (_base = global.state).identity) != null ? _ref2 : _base.identity = null;

  exports.is_authenticated = function() {
  ...
  exports.get = function() {
    ...
    return new entities.Identity.build(data);
  };

  exports.persist = function(i) {
    return localStorage.setItem('identity', JSON.stringify(i));
  };
...
require.define("/www/scripts/global.coffee",function(require,module,exports,__dirname,__filename,process,global){(function() {
  var topLevel;

  topLevel = typeof window === 'undefined' ? global : window;
...
require.define("/server/entities.coffee",function(require,module,exports,__dirname,__filename,process,global){(function() {
  var Identity, List, ListHeader, ListItem, Log, uuid, _, _ref;

  _ref = [require('underscore'), require('node-uuid')], _ = _ref[0], uuid = _ref[1];

  module.exports = {
    Identity: Identity = (function() {

      function Identity(_id, password, hash) {
        this._id = _id;
        this.password = password;
        this.hash = hash != null ? hash : this.hash || '';
        this.type = 'Identity';
      }

      Identity.prototype.email = function() {
        return this._id;
      };

      Identity.prototype.toWire = function() {
        return _.pick(this, '_id', 'password');
      };

      return Identity;

    })(),
    ListHeader: ListHeader = (function() {

      function ListHeader(id, title) {
        this.id = id;
        this.title = title;
      }
    ...
    List: List = (function() {
      ...
      function List(receiver, sender, title, list_content) {
        this.receiver = receiver;
        this.sender = sender;
        this.title = title;
        this.parse_raw_list(list_content);
      }

      List.prototype.parse_raw_list = function(raw_list) {
        var line, lines, trimmed;
        if (raw_list == null) {
          return;
        }
        lines = (function() {
          var _i, _len, _ref1, _results;
          _ref1 = raw_list.split('\n');
          _results = [];
          for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
            line = _ref1[_i];
            _results.push(this.trim(line));
          }
          return _results;
        }).call(this);
        return this.items = (function() {
          ...
          for (_i = 0, _len = lines.length; _i < _len; _i++) {
            ...
            if ((trimmed != null) && trimmed.length > 0) {
              _results.push(new ListItem(trimmed));
            }
          }
          return _results;
        })();
      ...
      List.prototype.trim = function(input) {
        if (input == null) {
          return '';
        }
      ...
      List.prototype.toWire = function() {
        return _.pick(this, 'receiver', 'sender', 'title', 'items', 'type');
      };

      return List;

    })(),
    ListItem: ListItem = (function() {
  ...
  module.exports.Identity.build = function(data) {
    return new module.exports.Identity(data._id, data.password);
  };
...
require.define("/www/scripts/states/state_loginregister.coffee",function(require,module,exports,__dirname,__filename,process,global){(function() {
  var entities, features, global, identity, server, statechart, validation, _ref;

  _ref = [require('../global'), require('../features'), require('../../../server/entities'), require('../validation'), require('../services/server'), require('../services/identity')], global = _ref[0], features = _ref[1], entities = _ref[2], validation = _ref[3], server = _ref[4], identity = _ref[5];
  ...
  statechart.addState('loginregister', {
    ...
    enterState: function() {
      ...
      return $('.loginregisteritem').click(function() {
        return statechart.sendEvent('navigate', $(this).attr('data-state'));
      });
    },
    exitState: function() {
  ...
  statechart.addState('login', {
    ...
    enterState: function() {
      ...
      return $('form#login > button').click(function() {
        ...
        auth_promise.fail(function(err) {
          console.log("err");
          console.dir(err);
          return statechart.sendEvent('alert', 'error', 'Login failed');
        });
        auth_promise.done(function(data) {
          identity.persist(_.extend({
  ...
  statechart.addState('register', {
    ...
    enterState: function() {
      ...
      return validation.validate_form($('#body-container'), validation.validate_register_form, function(err, form_data) {
        ...
        register_promise.then(function() {
          return statechart.sendEvent('navigate', 'listlist');
        });
        return register_promise.fail(function(err) {
...
require.define("/www/scripts/features.coffee",function(require,module,exports,__dirname,__filename,process,global){(function() {
  var identity, server, _ref;

  _ref = [require('./services/identity'), require('./services/server')], identity = _ref[0], server = _ref[1];
  ...
  module.exports = {
    register: function(i) {
      ...
      return dfd.done(function() {
        return identity.persist(i);
      });
    },
    list: function(list_id) {
      var me;
      me = identity.get();
      return server.get_list(me, list_id);
    },
    lists_list: function() {
      var me;
      me = identity.get();
      return server.get_lists(me);
    }
  };
...
require.define("/www/scripts/services/server.coffee",function(require,module,exports,__dirname,__filename,process,global){(function() {
  var base_url, basic_auth_before_send, config, dbc, identity, _ref;

  _ref = [require('./identity'), require('dbc'), require('../../../server/config')], identity = _ref[0], dbc = _ref[1], config = _ref[2];

  base_url = config.server_url;

  basic_auth_before_send = function(user) {
    return function(xhr) {
      return xhr.setRequestHeader('Authorization', "Basic " + btoa("" + user._id + ":" + user.password));
    };
  };
  ...
  exports.get_lists = function(user) {
    return $.ajax({
      dataType: "json",
  ...
  exports.get_list = function(user, list_id) {
    return $.ajax({
      dataType: 'json',
      beforeSend: basic_auth_before_send(user),
  ...
  exports.persist = function(entity) {
    return $.ajax({
      type: "POST",
      beforeSend: basic_auth_before_send(identity.get()),
  ...
  exports.update_listitem = function(listitem) {
    return $.ajax({
      type: "PUT",
      beforeSend: basic_auth_before_send(identity.get()),
...
require.define("/node_modules/dbc/package.json",function(require,module,exports,__dirname,__filename,process,global){module.exports = {"main":"./dbc.js"}
});

require.define("/node_modules/dbc/dbc.js",function(require,module,exports,__dirname,__filename,process,global){(function() {
...
require.define("/server/config.coffee",function(require,module,exports,__dirname,__filename,process,global){(function() {
  var base, env, environments, _;
...
require.define("/www/scripts/validation.coffee",function(require,module,exports,__dirname,__filename,process,global){(function() {
  var dbc, entities, read_form, revalidator, validate_form_assertions, validators, _, _ref;

  _ref = [require('../../server/entities'), require('underscore'), require('dbc'), require('revalidator')], entities = _ref[0], _ = _ref[1], dbc = _ref[2], revalidator = _ref[3];

  validate_form_assertions = function($form_container, validator, callback) {
    dbc.assert(($form_container != null) && $form_container.length === 1, '$form_container is invalid');
    dbc.assert_is_function(validator, 'validator must be a function');
    return dbc.assert_is_function(callback, 'callback must be a function');
  };
  ...
  read_form = function($form) {
    ...
    dbc.assert(target != null, 'data is invalid');
    return target;
  };
  ...
  module.exports = {
    ...
    resource: function(entity) {
      dbc.assert(entity.type != null, 'unable to validate a resource without a type');
      if (entity.type === 'List') {
    ...
    validate_send_form: function(data) {
      return validators.List(data);
    },
    register_identity: function(data) {
      return revalidator.validate(data, {
        properties: {
          _id: {
            required: true,
    ...
    update_listitem: function(listitem) {
      return revalidator.validate(listitem, validators['listitem']);
    },
    validate_form: function($form_container, validator, callback) {
      validate_form_assertions.apply(null, arguments);
      return $('form', $form_container).submit(function(e) {
        var data, result;
        e.preventDefault();
        data = read_form($(this));
        ...
        if (!result.valid) {
          ...
          $form_container.prepend(templates.errors({
...
require.define("/node_modules/revalidator/package.json",function(require,module,exports,__dirname,__filename,process,global){module.exports = {"main":"./lib/revalidator"}
});

require.define("/node_modules/revalidator/lib/revalidator.js",function(require,module,exports,__dirname,__filename,process,global){(function (exports) {
...
require.define("/www/scripts/states/state_send.coffee",function(require,module,exports,__dirname,__filename,process,global){(function() {
  var entities, identity, server, validation, _ref;

  _ref = [require('../../../server/entities'), require('../validation'), require('../services/identity'), require('../services/server')], entities = _ref[0], validation = _ref[1], identity = _ref[2], server = _ref[3];
  ...
  statechart.addState('send', {
    ...
    enterState: function() {
      ...
      return validation.validate_form($('#body-container'), validation.validate_send_form, function(err, form_data) {
        ...
        send_promise.done(function(data, textStatus, jqXHR) {
          statechart.sendEvent('navigate', 'listlist');
          return statechart.sendEvent('alert', 'success', "" + form_data.title + " sent to " + form_data.receiver);
        });
        return send_promise.fail(function(jqXHR, textStatus, errorThrown) {
          return alert("send_promise failed " + (JSON.stringify(jqXHR)));
        });
      });
    },
    backbutton: function() {
...
require.define("/www/scripts/states/state_lists.coffee",function(require,module,exports,__dirname,__filename,process,global){(function() {
  var features, global, server, _, _ref;

  _ref = [require('../global'), require('../features'), require('underscore'), require('../services/server')], global = _ref[0], features = _ref[1], _ = _ref[2], server = _ref[3];
  ...
  statechart.addState('listlist', {
    ...
    enterState: function() {
      ...
      lists.then(function(data) {
        $('#body-container').append(templates.listlist({
          lists: data
        }));
        return $('.listlistitem').click(function() {
          var id;
          id = $(this).attr('data-id');
          statechart.getState('list').setData('id', id);
          return statechart.sendEvent('navigate', 'list');
        });
      });
      return lists.fail(function(err) {
        console.dir(err);
        return alert(JSON.stringify(err));
      });
    },
    ...
    enterState: function(id) {
      ...
      render_bind = function(list) {
        ...
        return $('.listitem').click(function() {
          ...
          clicked_item = _.find(list.items, function(i) {
            return $button.text() === (" " + i.description);
          });
          clicked_item.completed = !clicked_item.completed;
          ...
          return update_item_d.fail(function(err) {
            return console.dir(err);
          });
        });
      };
      list_deferred.done(render_bind);
      return list_deferred.fail(function(err) {
        console.dir(err);
        return alert(JSON.stringify(err));
      });
    },
...
require.define("/www/scripts/services/menu.coffee",function(require,module,exports,__dirname,__filename,process,global){(function() {
  var identity;
  ...
  module.exports = {
    update: function() {
      if (identity.is_authenticated()) {
        ...
        $('#menu-listlist').show();
        return $('#menu-send').show();
      } else {
        $('#user-info').empty();
        $('#menu-listlist').hide();
        return $('#menu-send').hide();
      }
    }
  };
...
require.define("/www/scripts/states/statechart.coffee",function(require,module,exports,__dirname,__filename,process,global){(function() {
  ...
  activate_menu = function() {
    menu.update();
    return $('ul.nav a').click(function() {
      var target_state;
      ...
      if (/menu-.*/.test($(this).attr('id'))) {
        ...
        return statechart.sendEvent('navigate', target_state);
      }
    });
  };
  ...
  statechart.addState("running", {
    ...
    alert: function(level, message) {
      $('#body-container').prepend(templates.alert({
        level: level,
        message: message
      }));
...
require("/www/scripts/states/statechart.coffee");
})();
